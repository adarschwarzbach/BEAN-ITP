...
interface BeanResultsType {
    statusCode: number;
    body: ComputationResult;
}
...
interface DataContextProps {
	...
	beanResults: BeanResultsType;
	setBeanResults: React.Dispatch<React.SetStateAction<BeanResultsType>>;
}
...
export const DataProvider: React.FC<DataProviderProps> = ({ children }) => {
	...
	const [beanResults, setBeanResults] = useState<BeanResultsType>(initialData);
	...
	return (
		<DataContext.Provider value={{ ionicEffect, setIonicEffect, loading, setLoading, speciesDict, setSpeciesDict, beanResults, setBeanResults }}>
			{children}

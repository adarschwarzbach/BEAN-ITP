...
def lambda_handler(event, context):
        ...
        point_c_CI = event.get('point_c_CI')
        ...
        def InitialConditions_updated(species, point_c_LE, point_c_CI):
            """
            ...
            species[1]["concentration"] = [point_c_CI]
            cMat_read[1, :] = point_c_CI
        ...
        (
            ...
            cH,
            IonicCalcFlag,
        ) = InitialConditions_updated(species, point_c_LE, point_c_CI)
        ...
        try:
            result = {
                "computation_value": pH[0, 1],
                "itpCheck": Focus == 1,
                "input": {'point_c_CI': point_c_CI, 'point_c_LE':point_c_LE },

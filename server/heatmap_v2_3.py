...
def InitialConditions_updated(filename, point_c_LE, point_c_CI):
...
# ARGUMENTS FOR THE HEATMAP 3 GO HERE
...
(
    ...
    cH,
    IonicCalcFlag,
) = InitialConditions_updated(input_file, point_c_LE, point_c_CI)

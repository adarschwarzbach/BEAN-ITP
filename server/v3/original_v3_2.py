...
def InitialConditions_updated(filename, point_c_LE, point_mobility_TE):
    ...
    species[3]["mobility"] = [point_mobility_TE]
...
# ARGUMENTS FOR THE HEATMAP 2 GO HERE
input_file = sys.argv[1]
point_mobility_TE = -3.947368421052632e-08
point_c_LE = 0.035
...
(
    ...
    cH,
    IonicCalcFlag,
) = InitialConditions_updated(input_file, point_c_LE, point_mobility_TE)

...
# species = {0 : {'Name': 'Sebacic-Acid', 'valence': [-2, -1], 'mobility': [-4.49e-008, -2.07e-008 ], 'pKa': [5.38, 4.53], 'concentration': 0.00021, 'type': 'LE'}|
...
def InitialConditions():
    ...
    LMat, muMat, ValMat, DMat, KaMat, zListArranged, PolDeg = TFEquilibriumParameters(
        species)
    
    print(are_sets_close(TFEquilibriumParameters(species), EquilibriumParameters(species)))
